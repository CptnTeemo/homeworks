...
public class Main {
    ...
    private static Logger stationsLogger;
    ...
    public static void main(String[] args) {
        ...
        errorsLogger = LogManager.getRootLogger();
        stationsLogger = LogManager.getRootLogger();
        exceptionsLogger = LogManager.getRootLogger();
        Marker stationsMarker = MarkerManager.getMarker("stations");
        Marker exceptionsMarker = MarkerManager.getMarker("exceptions");
        ...
        for (; ; ) {
            try {
                ...
                stationsLogger.info(stationsMarker, "Поиск станции: " + from);
                Station to = takeStation("Введите станцию назначения:");
                stationsLogger.info(stationsMarker, "Поиск станции: " + to);
                ...
                exceptionsLogger.debug(exceptionsMarker,"Исключение: " + e.getMessage());
            }
        }
    }
